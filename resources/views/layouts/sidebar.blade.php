...
<div class="sidebar d-flex">
	<ul class="sidebar__app d-flex flex-column p-0">
		<ul class="sidebar-items app__docs">
			<li id="file-btn" class="item">
				<a class="item-link" href=""><i class="item__icon bi bi-file-earmark"></i></a>
			...
			<li id="folder-btn" class="item">
				<a class="item-link" href=""><i class="item__icon bi bi-folder"></i></a>
				<div class="file-btn--description">
		...
		<ul class="sidebar-items app__social">
			<li id="firend-btn" class="item">
				<a class="item-link" href=""><i class="item__icon bi bi-person"></i></a>
				<div class="file-btn--description">
					<span>Bạn bè</span>
				</div>
			</li>
	...
	<ul class="sidebar__user d-flex flex-column p-0">
		<ul class="sidebar-items user__controll">
			<li id="homebtn" class="item">
				<a class="item-link" href="/"><i class="item__icon bi bi-house-door"></i></a>
				<div class="file-btn--description">
					<span>Trang chủ</span>
				</div>
			</li>
			...
			<li id="login-btn" class="item">
				<a class="item-link" href="login"><svg class="item__icon" width="30px" height="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
		...
		<ul class="sidebar-items user__option">
			<li id="home-btn" class="item selected">
				<a class="item-link" href="/"><i class="item__icon bi bi-house-door"></i></a>
				<div class="file-btn--description">
					<span>Trang chủ</span>
				</div>
			...
			<li id="user-btn" class="item">
				<a class="item-link" href=""><i class="item__icon bi bi-person-circle"></i></a>
				<div class="file-btn--description">
					<span>Cá nhân</span>
				</div>
			</li>
			...
			<li id="logout-btn" class="item">
				<a class="item-link" href=""><svg class="item__icon" width="30px" height="30px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50">
